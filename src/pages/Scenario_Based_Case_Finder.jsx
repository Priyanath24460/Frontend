          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-6 lg:gap-8">
                  ...
                  <div className="space-y-2">
                    {exampleQueries.map((query, index) => (
                      <button
                        ...
                        className="w-full text-left p-3 bg-linear-to-r from-amber-50 to-orange-50 hover:from-amber-100 hover:to-orange-100 rounded-lg border border-amber-200 hover:border-amber-300 transition-all duration-200 group"
                      >
                        <div className="flex items-start">
                          <svg className="w-4 h-4 text-amber-600 mr-2 mt-0.5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 5l7 7-7 7" />
                          </svg>
            ...
            <div className="lg:col-span-3">
              <div className="bg-white rounded-2xl shadow-xl p-6 lg:p-8 border-t-4 border-orange-500">
                ...
                {isLoading && (
                  <div className="text-center py-16">
                    <div className="relative w-24 h-24 mx-auto mb-6">
                      <div className="absolute inset-0 bg-linear-to-br from-amber-100 to-orange-100 rounded-full animate-ping opacity-75"></div>
                      <div className="relative w-24 h-24 bg-linear-to-br from-amber-200 to-orange-200 rounded-full flex items-center justify-center shadow-lg">
                ...
                {!result && !isLoading && (
                  <div className="text-center py-16">
                    <div className="w-24 h-24 mx-auto mb-6 bg-linear-to-br from-amber-100 to-orange-100 rounded-full flex items-center justify-center shadow-lg">
                    ...
                    <div className="max-w-md mx-auto bg-linear-to-br from-blue-50 to-indigo-50 rounded-xl p-6 border border-blue-100">
                      ...
                      <ul className="text-sm text-blue-800 space-y-2 text-left">
                        <li className="flex items-start">
                          <svg className="w-4 h-4 text-blue-600 mr-2 mt-0.5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
