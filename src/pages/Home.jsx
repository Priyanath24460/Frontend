  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="pt-16">
        {/* Hero Section */}
        <section className="bg-linear-to-br from-stone-600 via-amber-900 to-orange-800 text-white py-24 relative overflow-hidden min-h-[600px]">
          {/* Background Image */}
          ...
          <div className="relative max-w-7xl mx-auto px-8 h-full flex items-center min-h-[600px]">
            <div className="w-full lg:w-3/5 xl:w-1/2 space-y-10">
              ...
              <div className="text-left">
                ...
                <div className="w-24 h-1 bg-linear-to-r from-amber-400 to-orange-400 mb-8"></div>
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-4 pt-2">
                <Link 
                  ...
                  className="group relative bg-linear-to-r from-amber-400 to-orange-400 text-stone-900 px-10 py-4 rounded-lg font-semibold text-lg hover:from-amber-300 hover:to-orange-300 transition-all duration-300 shadow-xl hover:shadow-2xl hover:shadow-amber-400/40 hover:scale-105 overflow-hidden"
                >
        ...
        <section className="py-24 bg-white">
          <div className="max-w-7xl mx-auto px-8">
            <div className="text-center mb-16">
              ...
              <div className="w-24 h-1 bg-linear-to-r from-amber-400 to-orange-400 mx-auto mb-6"></div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div className="group bg-linear-to-br from-stone-50 to-amber-50 p-8 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-1 border border-amber-100">
                <div className="flex items-start gap-5">
                  <div className="shrink-0 w-14 h-14 bg-linear-to-br from-amber-400 to-orange-400 rounded-xl flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform">
        ...
        {/* About Section */}
        <section className="py-24 bg-linear-to-b from-stone-50 to-white">
          <div className="max-w-6xl mx-auto px-8">
            <div className="text-center mb-20">
              <div className="inline-flex items-center justify-center w-20 h-20 bg-linear-to-br from-stone-700 to-amber-600 rounded-full mb-8 shadow-xl">
                <svg className="w-10 h-10 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                </svg>
              </div>
              <h2 className="text-4xl lg:text-5xl font-bold text-stone-800 mb-6">About LawKnow</h2>
              <div className="w-32 h-1 bg-linear-to-r from-stone-700 to-amber-600 mx-auto mb-8"></div>
              ...
              <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-8">
                <div className="text-center p-8 rounded-2xl bg-white shadow-lg hover:shadow-xl transition-shadow">
                  <div className="text-5xl font-bold bg-linear-to-r from-amber-600 to-orange-500 bg-clip-text text-transparent mb-3">10,000+</div>
                  <div className="text-gray-700 font-semibold text-base">Legal Documents Processed</div>
                </div>
                <div className="text-center p-8 rounded-2xl bg-white shadow-lg hover:shadow-xl transition-shadow">
                  <div className="text-5xl font-bold bg-linear-to-r from-amber-600 to-orange-500 bg-clip-text text-transparent mb-3">500+</div>
                  <div className="text-gray-700 font-semibold text-base">Legal Professionals Trust Us</div>
                </div>
                <div className="text-center p-8 rounded-2xl bg-white shadow-lg hover:shadow-xl transition-shadow">
                  <div className="text-5xl font-bold bg-linear-to-r from-amber-600 to-orange-500 bg-clip-text text-transparent mb-3">99.9%</div>
        ...
        <section className="py-24 bg-linear-to-b from-white to-amber-50">
          <div className="max-w-7xl mx-auto px-8">
            <div className="text-center mb-20">
              <div className="inline-flex items-center justify-center w-20 h-20 bg-linear-to-br from-amber-600 to-yellow-500 rounded-full mb-8 shadow-xl">
                <svg className="w-10 h-10 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="w-32 h-1 bg-linear-to-r from-amber-600 to-yellow-500 mx-auto mb-8"></div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
              <div className="group text-center p-10 rounded-3xl bg-white border-2 border-amber-100 hover:border-amber-300 hover:shadow-2xl transition-all duration-500 hover:-translate-y-2">
                <div className="w-24 h-24 bg-linear-to-br from-amber-500 to-amber-600 rounded-full flex items-center justify-center mx-auto mb-8 group-hover:from-amber-600 group-hover:to-amber-700 transition-all duration-300 shadow-xl">
                ...
                <div className="w-16 h-1 bg-linear-to-r from-amber-500 to-yellow-400 mx-auto mb-4"></div>
              ...
              <div className="group text-center p-10 rounded-3xl bg-white border-2 border-orange-100 hover:border-orange-300 hover:shadow-2xl transition-all duration-500 hover:-translate-y-2">
                <div className="w-24 h-24 bg-linear-to-br from-orange-500 to-orange-600 rounded-full flex items-center justify-center mx-auto mb-8 group-hover:from-orange-600 group-hover:to-orange-700 transition-all duration-300 shadow-xl">
                  <svg className="w-12 h-12 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 14l9-5-9-5-9 5 9 5zm0 0l6.16-3.422a12.083 12.083 0 01.665 6.479A11.952 11.952 0 0012 20.055a11.952 11.952 0 00-6.824-2.998 12.078 12.078 0 01.665-6.479L12 14z" />
                  </svg>
                </div>
                <h4 className="text-2xl font-bold text-amber-900 mb-4">Law Students</h4>
                <div className="w-16 h-1 bg-linear-to-r from-orange-500 to-yellow-400 mx-auto mb-4"></div>
              ...
              <div className="group text-center p-10 rounded-3xl bg-white border-2 border-yellow-100 hover:border-yellow-300 hover:shadow-2xl transition-all duration-500 hover:-translate-y-2">
                <div className="w-24 h-24 bg-linear-to-br from-yellow-500 to-yellow-600 rounded-full flex items-center justify-center mx-auto mb-8 group-hover:from-yellow-600 group-hover:to-yellow-700 transition-all duration-300 shadow-xl">
                  <svg className="w-12 h-12 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" />
                  </svg>
                </div>
                <h4 className="text-2xl font-bold text-amber-900 mb-4">Citizens & Businesses</h4>
                <div className="w-16 h-1 bg-linear-to-r from-yellow-500 to-amber-400 mx-auto mb-4"></div>
        ...
        {/* Call to Action */}
        <section className="py-32 bg-linear-to-br from-stone-900 via-amber-900 to-orange-800 text-white relative overflow-hidden">
          ...
          <div className="relative max-w-5xl mx-auto px-8 text-center">
            <div className="mb-12">
              <h3 className="text-4xl lg:text-5xl xl:text-6xl font-bold mb-8 bg-linear-to-r from-amber-300 to-orange-200 bg-clip-text text-transparent leading-tight">Ready to Transform Your Legal Practice?</h3>
              <div className="w-32 h-1 bg-linear-to-r from-amber-400 to-orange-400 mx-auto mb-10"></div>
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center mt-16">
              <Link to="/Scenario_Based_Case_Finder" className="group bg-linear-to-r from-amber-400 to-orange-400 text-stone-900 px-12 py-6 rounded-2xl font-bold text-xl hover:from-amber-300 hover:to-orange-300 transition-all duration-300 shadow-2xl hover:shadow-amber-400/30 hover:-translate-y-2">
